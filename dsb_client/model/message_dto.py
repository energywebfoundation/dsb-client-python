...
class MessageDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, topic, payload, signature, sender, timestamp_nanos, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, topic, payload, signature, sender, timestamp_nanos, *args, **kwargs):  # noqa: E501
        """MessageDto - a model defined in OpenAPI
