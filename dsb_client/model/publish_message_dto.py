...
class PublishMessageDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fqcn, payload, signature, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, fqcn, payload, signature, *args, **kwargs):  # noqa: E501
        """PublishMessageDto - a model defined in OpenAPI
