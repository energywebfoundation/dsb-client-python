...
class LoginReturnDataDTO(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, token, did, address, signature, *args, **kwargs):  # noqa: E501
        """LoginReturnDataDTO - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, token, did, address, signature, *args, **kwargs):  # noqa: E501
        """LoginReturnDataDTO - a model defined in OpenAPI
