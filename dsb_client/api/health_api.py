...
class HealthApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __health_controller_check(
            self,
            **kwargs
        ):
            """health_controller_check  # noqa: E501
        ...
        self.health_controller_check = _Endpoint(
            settings={
                'response_type': (InlineResponse200,),
                'auth': [],
                'endpoint_path': '/health',
                'operation_id': 'health_controller_check',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__health_controller_check
        )
